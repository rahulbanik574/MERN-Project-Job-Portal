...
<FiSearch className='absolute mt-2.5 ml-2 text-gray-400' />
        ...
        {/* location */}
        <div className='flex md:rounded-s-none
        
         rounded shadow-sm ring-1  ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
