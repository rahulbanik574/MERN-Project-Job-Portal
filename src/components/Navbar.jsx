...
//         <a href="/" className="flex items-center gap-2 text-2xl text-black"><span>Job Portal</span></a>
...
const Navbar = () => {
  ...
  return (
    <header className="max-w-screen-2xl conatainer mx-auto xl:px-24 px-4">
<nav className="flex justify-between items-center py-6">
  <a href="/"><span><b>JobPortal</b></span></a>
  <ul className="hidden md:flex gap-12">
 {
   navItems.map(({path,title}) => (
     <li key={path} className="text-base text-primary">
